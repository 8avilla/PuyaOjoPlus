...
include_once '../inc/DAO/Servicios.php';
...
<html>
    ...
    <body class="hold-transition <?php echo $servicio->apariencia($_SESSION['user']);?> sidebar-mini" BGCOLOR="red">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box-header with-border">
                      ...
                      <div class="box-tools pull-right">
                        <span class="label label-success">Nuevos Lideres</span>
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                      </div>
                    </div><!-- /.box-header -->
                    <div class="box-body no-padding">
                      <ul class="users-list clearfix">
                        <li>
                          ...
                          <a class="users-list-name" href="#">IVAN JOSE</a>
                          <span class="users-list-date">Lider</span>
                        </li>
                        <li>
                          <img src="../dist/img/user8-128x128.jpg" alt="User Image">
                        ...
                        <div class="col-md-4">
                           ...
                           <?php 
                                ...
                                $elements->logoPartido($user);
                           
                                $elements->VotacionTotal($user);
                            ?>
                            <!-- ./col -->
                            </div>
                        ...
                        <div class="box box-danger">
                            ...
                            <h3> <strong>Castigador</strong></h3>
                            <input type="text" class="knob" value="100" data-width="120" data-height="120" data-fgColor="#f56954">
                            ...
                            <div class="box box-info">
                                ...
                                <div style="padding: 20px">
                                    ...
                                    <?php $elements->barraEstadistica($user);
